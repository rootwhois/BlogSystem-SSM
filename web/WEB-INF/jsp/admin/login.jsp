...
<div id="login">
    <div class="form-inline">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="id" id="adminId" required>
        </div>
        <br/><br/>
        <div class="input-group">
        ...
        <p style="text-align: center;color: black;"><a
                href="${pageContext.request.contextPath}/login/reset/step1">忘记密码？</a></p>
        <br/>
    ...
    <script>
        ...
        $("#loginButton").click(function () {
            if ($("#adminId").val() == '' && $("#passwd").val() == '') {
                ...
                if (!patrn.test($("#passwd").val())){
                    $("#info").text("只能输入6-20个字母、数字、下划线");
                }else{
                    $.ajax({
                        type: "POST",
