...
<div class="container">
    <form action="${pageContext.request.contextPath}/admin/sort/edit/do">
        <input type="hidden" value="${sort.sortId}" name="id">
        <div class="form-group">
            <label for="name">分类名</label>
            <input type="text" class="form-control" id="name" name="name" placeholder="分类名" value="${sort.sortName}"
                   required>
        </div>
        <input type="submit"/>
